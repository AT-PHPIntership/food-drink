  ...
  <div class="wrapper">
    <header class="main-header">
      ...
      <a href="{{route('admin')}}" class="logo">
        ...
        <span class="logo-lg">{{__('user.admin.manage')}}</span>
      </a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <span class="hidden-xs">{{__('user.admin.admin')}}</span>
              </a>
              <ul class="dropdown-menu">
                ...
                <li class="user-header">
                  ...
                  <p>{{__('user.admin.admin')}}</p>
                </li>
                <!-- Menu Footer-->
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="#" class="btn btn-default btn-flat">{{__('user.admin.profile')}}</a>
                  </div>
                  <div class="pull-right">
                    <a href="#" class="btn btn-default btn-flat">{{__('user.admin.sign_out')}}</a>
                  </div>
                </li>
              </ul>
            </li>
