            ...
            <div class="mini-cart">
              ...
              <div>
                <div class="top-cart-content">
                  ...
                  <div class="top-subtotal">Subtotal: <span class="price">$<span class="sub-total">0</span></span></div>
                  <div class="actions">
                    <a href="{{ route('cart.index') }}" class="view-cart"><i class="fa fa-shopping-cart"></i> <span>View Cart</span></a>
                    <a href="{{ route('orders.create') }}" class="btn-checkout" ><i class="fa fa-check"></i><span>Checkout</span></a>
                  </div>
                </div>
              </div>
            </div>
